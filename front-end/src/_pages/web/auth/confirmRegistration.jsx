...
export default function ConfirmRegistration() {
    ...
    useEffect(() => {
        const confirmRegistration = async () => {
            try {
                const response = await axios.post('http://localhost:3001/auth/confirm-registration', { token: searchParams.get('tkn') });
                ...
                console.error('Erro ao confirmar registro:', error.response.data.mensagem);
